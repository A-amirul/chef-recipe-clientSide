...
const Blogs = () => {
	...
	return (
		<div>
			<div className='text-center md:text-end p-8'>
				<button
					className="receipt-modal-download-button bg-blue-600 text-white rounded-lg p-2 px-8"
					onClick={downloadPDF}
			...
			<div className='mx-16 md:mx-24 my-8 actual-receipt'>
				<div>
